        ...
        <Grid container spacing={3}>
          <Grid item xs={6}>
            ...
            <FormControl className={classes.formControl}>
              ...
              >
                {	
                  ciudades && ciudades.map((city,i)=>{
                    return(
                      
                        <MenuItem key={i} value={city.CiudadID}>{city.CiudadNombre}</MenuItem>
            ...
            {	
                  noticiasCiudad && noticiasCiudad.news.map((newsCity,j)=>{
                    return(
          ...
          <Grid item xs={6}>
            ...
            <ol>
              {
                historial && historial.data.map ( (itemHistorial) => {
                  return(
                    <li>{itemHistorial.CiudadNombre}</li>
                  )
                }
                )
              }
